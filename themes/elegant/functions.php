...
function _ex_elegant_cal_title(&$_cur_cal,$links)
{
...
function _ex_elegant_content_title($l="",$m="",$r="")
{
...
function _ex_elegant_tabs($tabs)
{
...
function _ex_elegant_content_header()
{
...
function _ex_elegant_content_footer($links)
{
