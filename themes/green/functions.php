...
function _ex_green_cal_title(&$_cur_cal,$links)
{
...
function _ex_green_content_title($l="",$m="",$r="")
{
...
function _ex_green_section_header($text)
{

   echo("<table cellpadding=0 cellspacing=0 align=center width='100%'>\n");
   echo("<tr><td align=left nowrap
        width=10><img src='". _CAL_BASE_URL_ ."themes/green/images/header_bg_lt.gif'
	width=35 height=24
...
function _ex_green_content_header()
{
...
style='border-collapse: collapse;'>
<tr>
<td class='body'><img src='". _CAL_BASE_URL_ ."themes/green/images/header_bg_lt.gif' alt='header'></td>
<td class='main_header' width='100%'></td>
<td align='center' class='body'><img src='". _CAL_BASE_URL_."themes/green/images/header_bg_rt.gif'
...
function _ex_green_content_footer($links)
{

   echo("<table width='100%' border=0 cellpadding=0 cellspacing=0
style='border-collapse: collapse'>
<tr valign='middle'>
<td class='body'><img src='". _CAL_BASE_URL_ ."themes/green/images/header_bg_lb.gif' alt='footer'></td>
...
<td class='body'><img src='". _CAL_BASE_URL_ ."themes/green/images/header_bg_rb.gif' alt='footer'></td>
</tr>
</table>
");
